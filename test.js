...
import { setResponseCallback } from 'k6/http';
...
export default function () {
    ...
    const host = "wss://social-service-loadtesting-mqtt.d2dragon.net/mqtt";
    const port = "443";
